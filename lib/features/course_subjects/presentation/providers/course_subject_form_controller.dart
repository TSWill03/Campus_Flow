...
class CourseSubjectFormController extends AutoDisposeNotifier<FormSubmissionState> {
  @override
  ...
  Future<CourseSubject?> submit({
    ...
    try {
      ...
      state = const FormSubmissionState.success('Disciplina salva com sucesso.');
      return subject;
    } catch (error) {
      state = FormSubmissionState.error('Nao foi possivel salvar a disciplina: $error');
      return null;
    }
  }
}
...
final courseSubjectFormControllerProvider =
    NotifierProvider.autoDispose<CourseSubjectFormController, FormSubmissionState>(
